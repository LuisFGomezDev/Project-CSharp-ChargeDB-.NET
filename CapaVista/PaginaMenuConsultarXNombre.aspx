<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaMenuConsultarXNombre.aspx.cs" Inherits="WebCargaBDUNO27.CapaVista.PaginaMenuConsultarXNombre" %>
        ...
        <table class="EstiloTablaGeneral">
            ...
            <tr>
                <td colspan="3" class="EstiloTablaGeneral">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                      <asp:Label ID="LabelTitNombre" runat="server" Font-Bold="True" 
                          Font-Italic="True" Font-Size="Medium" ForeColor="White" 
                              Text="MENU CONSULTA CLIENTE X NOMBRE"></asp:Label>
                      <br />
                      <br />
                ...
                <td colspan="3" class="EstiloTablaGeneral">
                      <asp:Panel ID="Panel2" runat="server" class="EstiloPanelCabecera">
                          ...
                          <asp:Button ID="ButtonConsultaNombre" runat="server" 
                              onclick="ButtonConsultaNombre_Click" Text="Consultar Nombre" 
          ...
          <table class="EstiloBarraCuerpoCentral">
            <tr  valign="top">
                <td class="EstiloBarraCuerpoCentral" align="center">
                    <asp:Label ID="LabelTituloConsultaNombre" runat="server" Text="CONSULTA CLIENTE X NOMBRE" 
                        Visible="False" Font-Bold="True" ForeColor="#ED018C" Font-Size="Medium"></asp:Label>
                    <asp:GridView ID="ListaGridConsultarClienteNombre" runat="server" AllowPaging="True" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [TablaBDsCarga] WHERE ([Nombre] LIKE '%' + @Nombre + '%') OR ([Apellido] LIKE '%' + @Nombre + '%') ORDER BY [MesRemision]">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextNombre" Name="Nombre" 
                                PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
