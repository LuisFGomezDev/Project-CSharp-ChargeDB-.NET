...
{
    public partial class WebMenuConsultarXEmail_CargaBD : System.Web.UI.Page
    {
        ...
        protected void ButtonConsultaEmail_Click(object sender, EventArgs e)
        {
            ...
            string EmailCliente = TextEmail.Text;
            ...
            if (EmailCliente != "")
            {
                ...
                //Se envian el Email del cliente y el tipo 2 = Email
                ListaCC_Completa = ObjTablaDatos.ConsultarDatosTabla(EmailCliente, 2);
