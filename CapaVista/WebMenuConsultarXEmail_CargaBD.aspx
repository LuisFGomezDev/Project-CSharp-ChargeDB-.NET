<%@ Page Title="" Language="C#" MasterPageFile="~/CapaVista/Page_Maestra_Cargador.Master" AutoEventWireup="true" CodeBehind="WebMenuConsultarXEmail_CargaBD.aspx.cs" Inherits="WebCargaBDUNO27.CapaVista.WebMenuConsultarXEmail_CargaBD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceCargador" runat="server">
        ...
        <asp:Label ID="LabelEmail" runat="server" Text="Digite Email del Cliente:" 
...
<div class="EstiloBarraCuerpoCentral">
    <asp:Label ID="LabelTituloBases" runat="server" Text="CONSULTA X EMAIL CLIENTE" Visible="False" Font-Bold="True" ForeColor="#ED018C" Font-Size="Medium">
    </asp:Label>
