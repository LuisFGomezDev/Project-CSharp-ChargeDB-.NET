<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaginaMenuConsultarXEmail.aspx.cs" Inherits="WebCargaBDUNO27.CapaVista.PaginaMenuConsultarXEmail" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>PAGINA CONSULTA CLIENTE X EMAIL</title>
    <style type="text/css">
    </style>
        ...
        <table class="EstiloTablaGeneral">
            ...
            <tr>
                <td colspan="3" class="EstiloTablaGeneral">
                      ...
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
                      <asp:Label ID="LabelTitEmail" runat="server" Font-Bold="True" 
                          Font-Italic="True" Font-Size="Medium" ForeColor="White" 
                              Text="MENU CONSULTA CLIENTE X EMAIL"></asp:Label>
                      <br />
                      <br />
            ...
            <tr>
                <td colspan="3" class="EstiloTablaGeneral">
                      <asp:Panel ID="Panel2" runat="server" class="EstiloPanelCabecera">
                          <br />
                          <br />
                          <asp:Label ID="LabelEmail" runat="server" Text="Digite el Email del cliente:" 
                              Font-Bold="True" ForeColor="#FEFF00" Font-Size="Medium"></asp:Label>
                          &nbsp;&nbsp;&nbsp;
                          <asp:TextBox ID="TextEmail" runat="server"></asp:TextBox>
                          &nbsp;&nbsp;
                          <asp:Button ID="ButtonConsultaEmail" runat="server" 
                              onclick="ButtonConsultaEmail_Click" Text="Consultar Email" 
          ...
          <table class="EstiloBarraCuerpoCentral">
            <tr  valign="top">
                <td class="EstiloBarraCuerpoCentral" align="center">
                    <asp:Label ID="LabelTituloBases" runat="server" Text="CONSULTA CLIENTE X EMAIL" 
                        Visible="False" Font-Bold="True" ForeColor="#ED018C" Font-Size="Medium"></asp:Label>
                    <asp:GridView ID="ListaGridConsultarClienteEmail" runat="server" AllowPaging="True" 
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ...
                        SelectCommand="SELECT * FROM [TablaBDsCarga] WHERE ([Email] LIKE @Email + '%') ORDER BY [MesRemision]">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextEmail" DefaultValue="" Name="Email" 
                                PropertyName="Text" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
