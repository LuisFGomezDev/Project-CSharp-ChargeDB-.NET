<%@ Page Title="" Language="C#" MasterPageFile="~/CapaVista/Page_Maestra_Cargador.Master" AutoEventWireup="true" CodeBehind="WebMenuConsultarXTel_CargaBD.aspx.cs" Inherits="WebCargaBDUNO27.CapaVista.WebMenuConsultarXTel_CargaBD" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceCargador" runat="server">
        ...
        <asp:Label ID="LabelTel" runat="server" Text="Digite Telefono del Cliente:" 
        ...
        <asp:Button ID="ButtonConsultaTel" runat="server" 
         onclick="ButtonConsultaTel_Click" Text="Consultar Telefono" 
...
<div class="EstiloBarraCuerpoCentral">
    <asp:Label ID="LabelTituloBases" runat="server" Text="CONSULTA X TELEFONO CLIENTE" Visible="False" Font-Bold="True" ForeColor="#ED018C" Font-Size="Medium">
    </asp:Label>
